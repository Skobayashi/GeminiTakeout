...
class model extends Base\AbstractCommand
{
    ...
    public function execute (Array $params)
    {
        try {
            ...
            $model = ROOT_PATH.'/library/Takeout/Model/'.$this->model_name.'Model.php';
            ...
            $model = ROOT_PATH.'/library/Takeout/Model/Column/'.$this->model_name.'Column.php';
            ...
            $model = ROOT_PATH.'/library/Takeout/Model/Query/'.$this->model_name.'Query.php';
    ...
    {
        $data = str_replace('Takeout', $this->app_name, $data);
